...
const posts = [
  { title: 'Top 5 Construction Trends in Ontario for 2024', slug: 'construction-trends-ontario-2024', cat: 'Industry News', img: '/images/buz_aerial_site.png', excerpt: 'From mass timber to net-zero construction, Ontario\'s building industry is evolving rapidly. Here\'s what to watch in 2024 and beyond.', author: 'Bilal Khan', date: 'November 15, 2024', readTime: '5 min read' },
  { title: 'How Design-Build Saves Time and Money on Your Project', slug: 'design-build-saves-time-money', cat: 'Services', img: '/images/design_build_1781694386091.png', excerpt: 'The design-build delivery method is changing how Ontario developers approach commercial and residential construction. Here\'s why.', author: 'Ubaid Khan', date: 'October 22, 2024', readTime: '6 min read' },
  { title: 'Kitchen Renovation Guide: What to Expect and How to Budget', slug: 'kitchen-renovation-guide-budget', cat: 'Renovations', img: '/images/kitchen_renovation_1781694354275.png', excerpt: 'Thinking about renovating your kitchen? Here\'s your complete guide to planning, budgeting, and executing a successful kitchen renovation.', author: 'Zaidan Anees', date: 'September 30, 2024', readTime: '8 min read' },
  { title: 'Understanding LEED Certification for Commercial Buildings', slug: 'leed-certification-commercial', cat: 'Commercial', img: '/images/commercial_office_1781694315339.png', excerpt: 'LEED certification is becoming a standard expectation in Ontario commercial construction. What does it mean, and what does it cost?', author: 'Ubaid Khan', date: 'September 10, 2024', readTime: '7 min read' },
  { title: 'Custom Home Building: From Lot Purchase to Move-In', slug: 'custom-home-building-guide', cat: 'Residential', img: '/images/residential_luxury_home_1781694338229.png', excerpt: 'Building a custom home is a complex journey. Our step-by-step guide walks you through everything — from finding your lot to getting your occupancy permit.', author: 'Bilal Khan', date: 'August 20, 2024', readTime: '10 min read' },
  { title: 'Construction Site Safety: Our Zero-Incident Commitment', slug: 'construction-site-safety', cat: 'Safety', img: '/images/safety_workers_1781694419859.png', excerpt: 'At BUZ Construction, we believe every worker deserves to go home safely. Learn how our comprehensive safety program protects every person on every site.', author: 'Zaidan Anees', date: 'July 28, 2024', readTime: '5 min read' },
]
  ...
  return (
    <>
      ...
      <section className="page-hero">
        <div className="page-hero-bg"><Image src="/images/buz_blog_hero.png" alt="BUZ Construction blog" fill style={{objectFit:'cover'}}/></div>
